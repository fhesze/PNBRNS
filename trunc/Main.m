...
%
% Copyright (c) 2013  Mehdi Gharasoo, Falk Heße.
% This program is under the Modified-BSD license. 
% The terms can be found in the LICENSE.txt or on the project website. 
