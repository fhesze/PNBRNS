...
# listsolids: = [3,4];
 variables := [tracer1,tracer2,tracer3,tracer4] ;
...
rate1:= kdec_tracer1 * tracer1 ;
rate2:= kdec_tracer2 * tracer2 ;
rate3:= kdec_tracer3 * tracer3 ;
rate4:= kdec_tracer4 * tracer4 ;
...
# UNITS: Time in seconds, pcells and carryingCapacity in cells per volume, s in concentration or index, distance in m
...
bio_name := [kdec_tracer1, kdec_tracer2, kdec_tracer3, kdec_tracer4, poreRadius] ; 
bio_val := [kdec_tracer1_, kdec_tracer2_, kdec_tracer3_, kdec_tracer4_, poreRadius_] ; 
