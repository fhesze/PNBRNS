...
% plot(node_realXY(:,1), node_realXY(:,2), '+');
% plot(pore_realXY(:,1), pore_realXY(:,2), '>k');
% axis equal;

% for pore_i = 1:pores_no
%    
%     if pore_pos(pore_i,4)==1
%         
%         plot(pore_realXY(pore_i,1), pore_realXY(pore_i,2), 'or');
%         
%     end
%     
%     if pore_pos(pore_i,4)==2
%         
%         plot(pore_realXY(pore_i,1), pore_realXY(pore_i,2), 'or');
%         
%     end
